      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="mx-auto max-w-4xl">
          <div className="rounded-lg border border-neutral-800 bg-neutral-900/50 p-6 text-center">
            ...
            <p className="mt-2 text-sm text-neutral-500">
              Create a thread to start a conversation with the agent
            </p>
            <button className="mt-4 rounded-md bg-neutral-800 px-4 py-2 text-sm font-medium text-neutral-200 hover:bg-neutral-700">
              Create Thread
            </button>
          </div>
        </div>
